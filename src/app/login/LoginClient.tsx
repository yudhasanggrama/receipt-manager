...
export default function LoginClient() {
  ...
  // ✅ tambahkan guard: kalau sudah login, jangan tampilkan login (menang lawan back/forward cache)
  useEffect(() => {
    let alive = true;
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    // ✅ sudah benar: replace (bukan push)
    router.replace(next); // (boleh tetap "/dashboard", tapi next lebih konsisten)
    router.refresh();
  }
